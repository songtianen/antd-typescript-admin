...
@connect(
  ({
    ...
    listAndbasicAndlist,
    loading: loading.models.listAndbasicAndlist,
  }),
)
class BaseList extends Component<ListProps, ListState> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'listAndbasicAndlist/fetch',
      payload: {
        count: 5,
      },
    });
  ...
  handleSubmit = (e: React.FormEvent) => {
    ...
    form.validateFields((err: string | undefined, fieldsValue: BasicListItemDataType) => {
      ...
      dispatch({
        type: 'listAndbasicAndlist/submit',
...
export default Form.create<ListProps>()(BaseList);
